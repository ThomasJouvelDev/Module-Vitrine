...
Category.create!(id: 1, name: 'Vélo', key: 'velo')
Category.create!(id: 2, name: 'Chaussure', key: 'chaussure')
Category.create!(id: 11, name: 'Mobilier', key: 'mobilier')
Category.create!(id: 3, name: 'Mobilier-Commode', key: 'commode')
Category.create!(id: 4, name: 'Mobilier-Table', key: 'table')
Category.create!(id: 5, name: 'Mobilier-Bureau', key: 'bureau')
Category.create!(id: 6, name: 'Mobilier-Siège', key: 'siege')
Category.create!(id: 7, name: 'Poupée', key: 'poupee')
Category.create!(id: 8, name: 'Miroir', key: 'miroir')
Category.create!(id: 9, name: 'Jouet', key: 'jouet')
Category.create!(id: 10, name: 'Décoration', key: 'deco')
